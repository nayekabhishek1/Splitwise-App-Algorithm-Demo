...
//Upheapify give O(nlogn) time complexity
...
//Downheapify give O(n) time complexity
...
export function splitwise(transactions) {
  ...
  for (var i = 0; i < transactions.length; i++) {
    ...
    // person1 is the payer so he will get the money later i.e. under a credit
    // person2 is the payee so he will return the money later i.e. under a debit
